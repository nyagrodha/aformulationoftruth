...
function Home() {
  return (
    <main className="min-h-screen grid place-items-center p-8 bg-monsoonEarth text-colonialCream">
      <section className="space-y-4 text-center">
        <h1 className="font-tamil text-3xl sm:text-4xl text-spicedCrimson">
          ௐ ஶ்ரீ காலபைரவாய நம
        </h1>

        <p className="font-devanagari text-bayOfBengal text-xl">
          भैरवाय नमः
        </p>

        {/* Use Link so it routes to /questionnaire */}
        <Link
          to="/questionnaire"
          className="inline-block bg-terracotta hover:bg-spicedCrimson text-colonialCream px-6 py-3 rounded"
        >
          Proceed
        </Link>

        <div className="bg-sage text-monsoonEarth p-4 rounded">
          Earthy panel
        </div>
      </section>
    </main>
