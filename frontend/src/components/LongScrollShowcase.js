...
const LongScrollShowcase = () => {
  ...
  const mediaElements = [
    ...
    },
    {
      ...
      position: 80,
      duration: 15,
      style: { background: 'rgba(255,255,255,0.1)', padding: '2rem', borderRadius: '10px' }
    },
    {
      type: 'text',
      ...
      position: 85,
      duration: 15,
      style: { fontSize: '3.5rem', color: '#ccff00', textAlign: 'center', textShadow: '0 0 20px #ccff00' }
    }
  ];
      ...
      case 'audio':
        return (
          <div key={`audio-${index}`} style={baseStyle}>
            ...
            <div style={{ marginTop: '1rem', color: '#00ffff', fontSize: '1.2rem' }}>
              Ambient soundscape
            </div>
          </div>
        );
