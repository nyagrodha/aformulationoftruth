        ...
        <div style={styles.pageContainer}>
            ...
            <div style={styles.frame} className="neon-frame">
                ...
                <p style={styles.description}>
                    A practice in self-enquiry, these questions invite upon you--their respondents--a reflective states of consciousness. Diligence and a casual :30 to :45 or less depending upon one's proclivity to write. Users' efforts to craft responses (or non-responses!) betray something interior (அகம்) like a breath inhaled vivifies the subject, as such, a person and a formulation of truth.
                </p>
                <button 
                    style={styles.button} 
                    onClick={handleBegin}
