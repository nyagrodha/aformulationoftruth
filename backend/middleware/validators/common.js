 ...
 */
export const validateQuestionId = () => body('questionId')
    .isInt({ min: 1 })
    .withMessage('Question ID must be a positive integer');
/**
 * Answer text validation
 */
export const validateAnswerText = () => body('answer')
    .trim()
    .notEmpty()
 ...
 */
export const validateVerificationCode = () => body('code')
    .trim()
 ...
 */
export const validateSessionHash = () => body('sessionHash')
    .trim()
 ...
 */
export const validateTextField = (fieldName, minLength = 1, maxLength = 1000) => body(fieldName)
    .trim()
 ...
 * URL validation
 */
export const validateUrl = (fieldName = 'url') => body(fieldName)
    .trim()
 ...
 * Boolean validation
 */
export const validateBoolean = (fieldName) => body(fieldName)
    .isBoolean()
    .withMessage(`${fieldName} must be a boolean value`);
/**
 * Array validation
 */
export const validateArray = (fieldName, minLength = 1, maxLength = 100) => body(fieldName)
