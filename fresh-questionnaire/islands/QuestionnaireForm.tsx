...
export default function QuestionnaireForm({ questionId, questionText, sessionId }: QuestionnaireFormProps) {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      window.location.href = `/questionnaire?sessionId=${encodeURIComponent(sessionId)}`;
    } catch (err) {
