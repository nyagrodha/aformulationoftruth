...
export const OWN_ITEMS: ShopItem[] = [
  {
    ...
    title: "Abhinava-Tee",
    blurb:
      "Devotional-intellectual streetwear: part philosopher icon, part tantric diagram, part literary homage.",
    price: "$35",
  ...
  },
  {
    ...
    blurb:
      "Abhinavagupta in luminous neon, framed by a radiant mandala. Part tantra, part tech satire.",
    price: "$35",
