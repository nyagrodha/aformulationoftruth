  ...
  async generateQuestionnairePDF(responses: Response[], questionOrder?: number[]): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      try {
        ...
        doc.fontSize(14)
           .fillColor('#424242')
           .text('"The Divine Life is not a life of perfected mentality or even of perfected spirituality as these things are ordinarily conceived, but a life of gnostic consciousness."', 50, yPosition, {
             width: 500,
             align: 'center',
             lineGap: 8
           });
